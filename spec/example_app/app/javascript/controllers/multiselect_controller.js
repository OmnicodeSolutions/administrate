...
// Open-source implementation created by Vernes and Dino Maric.
// For full details and contributions, visit: https://github.com/WizardComputer/stimulus-multiselect
    ...
    if (this.disabledValue) {
      ...
      return `<div class="multiselect__pill" data-value="${item.value}" title="${item.text}">
        ...
        <span class="multiselect__pill-delete" data-action="click->multiselect#removeItem">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="12px" height="12px" fill="white">
